// Meu state está no app e quero passar uma função que altera uma chave dentro desse state
// para um button acionar quando ser clicado.
//
// 
// Árvore de Hierarquia de Componentes
// \App-----
//        \Page----  
//                 \Grid------
//                            \GridItem------
...
class Button extends Component {
  ...
  render() {
    const { click } = this.props;
    return (<button onClick={() => click()}></button>); // finalmente a props click será executada
