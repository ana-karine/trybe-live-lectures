...
test('o input recebe o valor pikachu', () => {
  render(<App />);
  const inputText = screen.getByTestId('input-text');
  userEvent.type(inputText, 'pikachu'); // o 'type' emula a digitação
  expect(inputText).toHaveValue('pikachu');
})
...
// - a função 'global' que queremos alterar o resultado: 'fetch';
// - a função 'fetch' é igualada ao 'jest.fn()';
// - o 'fetch', quando resolvido, retorna com uma chave 'json';
// - o 'json' também retorna uma promise.
